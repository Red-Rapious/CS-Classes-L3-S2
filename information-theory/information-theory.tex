...
\begin{definition}[Empirical distribution associated with a vector]
...
\begin{remark}[About the Glivenko-Cantelli theorem]
...
\begin{property}[Relationship to the cross entropy]
...
\begin{theorem}[Universal, asymptotically error-free source coding]
...
\begin{definition}[Distinctive parsing]
...
\begin{definition}[Longest distinctive parsing]
...
\begin{definition}[Parsing entropy]
...
\begin{lemma}[Distinctive parsing length bounds]
...
\begin{definition}[Source coding with a binary automaton]
...
\begin{definition}[Uniquely decodable and information lossless coding automata]
...
\begin{example}[UD block codes as finite IL automata]
...
\begin{definition}[Coding rate of finite IL automata]
...
\begin{property}[Parsing entropy and the coding rates of finite IL automata]
