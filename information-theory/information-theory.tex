...
\begin{proof}
    ...
    \end{equation*}
    In this regard, note by \eqref{eq:alpha-b} that
    \begin{equation*}
        M=1+\alpha(D-1) \xrightarrow[b\to+\infty]{} +\infty
    \end{equation*}
    and hence
    \begin{equation*}
        c \xrightarrow[b\to+\infty]{} -\log p_{\min} \in \lbrack0, +\infty\rbrack
    \end{equation*}
    The above observation and $H_2(W)\leq b$ implies that
    \begin{equation*}
        \E[L] \xrightarrow[b\to+\infty]{} +\infty
    \end{equation*}
    which completes the proof.
\end{proof}
