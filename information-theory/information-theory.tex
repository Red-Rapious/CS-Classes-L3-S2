...
\begin{definition}[Typical sequences]
    ...
    \begin{equation}
        A_\epsilon:=\left\{x\in \X^n \: : \: \big| -\frac{1}{n}\sum_{i=1}^n \log_Dp(x_i)-H_D\big|\leq \varepsilon\right\}\subseteq \X^n
    \end{equation}
...
\begin{property}[Typical sequences concentrate probability]
    ...
    Let $X=(X_1, \dots, X_n)$ be a vector of i.i.d. random variables, with $X_i\sim p$ on $\X$, with $D:=|\X|<\infty$. We have:
    \begin{equation}
        \label{eq:lim-p-1}
        \lim_{n\to+\infty}\P(X\in A_\epsilon)=1
    \end{equation}
    and
    \begin{equation}
        \label{eq:card-A}
        |A_\epsilon|\leq D^{n(H_D+\epsilon)}
    \end{equation}
\end{property}
...
\begin{proof}
    ...
    \begin{equation*}
        \begin{aligned}
            x\in A_\epsilon\implies& -\sum_{i=1}^n \log_D p(x_i)\leq n(H_D+\epsilon)\\
    ...
    \begin{equation*}
        \begin{aligned}
            1\geq \P(X\in A_\epsilon)&=\sum_{x\in A_\epsilon}p(x)\\
            &\geq |A_\epsilon|D^{-n(H_D+\epsilon)}
        \end{aligned}
    \end{equation*}
    which completes the proof.
\end{proof}

\begin{property}[$A_\epsilon$ is the smallest set concentrating probability]
    ...
    \begin{equation*}
        |B|\leq D^{nR}
    \end{equation*}
    Then $R\geq H_D$, that is that $A_\epsilon$ is the smallest set concentrating probability.
\end{property}
...
\begin{proof}
    ...
    \begin{equation*}
        \begin{aligned}
            x\in A_\epsilon\implies&-\sum_{i=1}^n \log_D p(X_i)\geq n(H_D-\epsilon)\\
    ...
    \begin{equation*}
        \begin{aligned}
            \P(X\in A_\epsilon\cap B)&\leq |B|D^{-n(H_D\epsilon)}\\
            &\leq D^{-n(H_D-R-\epsilon)}
        \end{aligned}
    \end{equation*}
    Since $D>1$ and $\lim_{n\to+\infty}\P(X\in A_\epsilon\cap B)=1$, we must have $H_D-R-\epsilon\leq 0$, meaning that $H_D-\epsilon\leq R$. We complete the proof by letting $\epsilon\to 0$. 
\end{proof}
