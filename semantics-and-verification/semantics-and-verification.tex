...
\begin{definition}[Weakest liberal preconditions]
    ...
    \end{equation*}
    and that $\wlp(c, P)$ is the weakest, i.e. most general, precondition ensuring that $\hoare{\wlp(c, P)}{c}{P}$ is a Hoare triple. Said otherwise, it is the greatest set that ensures that the computation ends up in $P$. Formally:
    \begin{equation*}
