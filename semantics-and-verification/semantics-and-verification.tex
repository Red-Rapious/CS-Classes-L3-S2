...
\begin{equation*}
    ...
    \end{aligned}
\end{equation*}
We use \emph{wlp} to infer assertions automatically when possible. $\vcgs(c, P)=(P', C)$ propagates postconditions backwards and accumulates into $C$ verification conditions (from loops).
