...
\begin{example}
    ...
    \begin{itemize}
        ...
        \item State properties (the \say{bad thing} is reaching $\S\setminus\mathcal{T}$)
...
We consider transition system $\Sc=(\S,\to,\S_{\mathcal{I}})$ and a safety property $\mathcal{T}$. Finite traces semantics is the least fixpoint of $F_*$. We seek a way of verifying that $\Sc$ satisfies $\mathcal{T}$, i.e. that $\llbracket \Sc\rrbracket^\alpha\subseteq\mathcal{T}$.
