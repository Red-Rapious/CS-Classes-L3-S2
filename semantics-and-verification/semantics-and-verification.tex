        ...
        \begin{minipage}{.5\textwidth}
          \begin{equation*}
            \begin{aligned}
                ...
                l_3 &: \roundsem{0\leq i<n \land s = \sum_{k=0}^{i-1}t[k]} \\
                l_4 &: \roundsem{0\leq i<n \land s = \sum_{k=0}^i t[k]} \\
                l_5 &: \roundsem{0\leq i\leq n \land s = \sum_{k=0}^{i-1}t[k]} \\
                l_6 &: \roundsem{i=n \land s = \sum_{k=0}^{n-1}t[k]}
            \end{aligned}
          \end{equation*}
        \end{minipage}
