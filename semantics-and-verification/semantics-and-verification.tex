...
\begin{figure}[H]
    ...
    \begin{grammar}
        \firstrule{expr}{X}{variable}
        \grule{c}{constant}
        \grule{$\lozenge$ expr}{unary operation}
        \grule{expr $\lozenge$ expr}{binary operation}
    ...
    \begin{tabular}{c}
        ...
        \begin{tabular}{c}
            \begin{prooftree}
                ...
                \infer2[($\lozenge\in\{+, -, \times, /\}$)]{\Gamma\vdash e_1\lozenge e_2: \textbf{int}}
            \end{prooftree}
        \end{tabular}
        \\
        \begin{tabular}{c}
            \begin{prooftree}
                \hypo{\Gamma\vdash e_1: \textbf{int}}
                \hypo{\Gamma\vdash e_2: \textbf{int}}
                \infer2[($\lozenge\in\{=,\neq,<,\leq\}$)]{\Gamma\vdash e_1\lozenge e_2: \textbf{bool}}
            \end{prooftree}
        \end{tabular}
        \\
        \begin{tabular}{c}
            \begin{prooftree}
                ...
                \infer2[($\lozenge\in\{=,\neq,\land,\lor\}$)]{\Gamma\vdash e_1\lozenge e_2: \textbf{bool}}
            \end{prooftree}
        \end{tabular}
    \end{tabular}
